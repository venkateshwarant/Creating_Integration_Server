...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
	...
	# chmod -R u+x $unzipped_directory
	# chmod -R u+x
	sudo chmod -R 777 $unzipped_directory/.
	sudo chmod -R 777 /home/vagrant/Katalon_Studio_Engine_Linux_64-7.0.10/.
        export PATH=$PATH:"/home/vagrant/Katalon_Studio_Engine_Linux_64-7.0.10"
